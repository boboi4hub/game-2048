...
function changeOpacityFull() {

    gameEndDialog.style.opacity = "1"; // Change opacity to 50%
}

function changeOpacityZero() {
    gameEndDialog.style.opacity = "0"; // Change opacity to 50%
}
